...
public:
    ...
    virtual NOX::LAPACK::Vector ComputeRHS(const NOX::LAPACK::Vector& aX, const double& aFrequency) override;
    // frequency domain to frequency domain
    virtual NOX::LAPACK::Matrix<double> ComputeJacobian(const NOX::LAPACK::Vector& aX, const double& aFrequency) override;
