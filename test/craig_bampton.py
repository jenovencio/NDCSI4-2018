...
data_folder = os.path.join(project_folder,r'data\files')

global_id_file = os.path.join(data_folder, 'global_id.dof')
global_K_file = os.path.join(data_folder,'global_K.sti')
global_mass_file = os.path.join(data_folder,'global_matrix.mas')
interface_K_stress_file = os.path.join(data_folder,'interface_K_stress.sti')
interior_id_file = os.path.join(data_folder,'interior_id.dof')
